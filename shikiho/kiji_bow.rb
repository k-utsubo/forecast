...
class MakeBOW
  def initialize
    ...
    @db2=SQLite3::Database.new("../../data/kiji.db")
    @db3=SQLite3::Database.new("../../data/kiji.db")

    @db.execute("delete from kiji_bow")
    @db.execute("delete from kiji_tf")
    @db.execute("delete from kiji_idf")
    @db.execute("delete from kiji_tfidf")
