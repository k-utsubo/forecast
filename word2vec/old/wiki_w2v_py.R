...
wordVectors::train_word2vec(
  #train_file = "../../data/wikipedia/data/text.txt", output_file = "../../data/model_wiki_text.txt",
  train_file = "../../data/wikipedia/data/text_new.txt", output_file = "../../data/model_wiki_text_new.txt",
