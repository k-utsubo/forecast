...
class LSTM(chainer.Chain):
    def __init__(self, in_units, hidden_units, out_units):
        super(LSTM, self).__init__(
            ...
            l6=L.LSTM(hidden_units, hidden_units),
            l7=L.LSTM(hidden_units, hidden_units),
            l8=L.LSTM(hidden_units, hidden_units),
            l9=L.Linear(hidden_units, out_units),
        )
...
def training_main(xp, in_units, hidden_units, out_units,training_epochs,mini_batch_size,length_of_sequence):
    model_path="./37a_model_"+str(hidden_units)+"_"+str(training_epochs)+"_"+str(length_of_sequence)+".bin"
    # make training data
...
if __name__ == "__main__":
    ...
    parser.add_argument('--sequence','-q',default=20, type=int)
